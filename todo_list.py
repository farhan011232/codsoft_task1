...
if __name__ == "__main__":  
    ...
    guiWindow.title("To-Do List Developed By - Farhan Khan")  
    # setting the geometry of the window  
    guiWindow.geometry("1000x750")  
    # disabling the resizable option  
    guiWindow.resizable()
    guiWindow.minsize(550,400)  
    # setting the background color to #FAEBD7  
    guiWindow.configure(bg = "#FFFF00")  
    ...
    header_frame = tk.Frame(guiWindow, bg = "#FF6347")  
    functions_frame = tk.Frame(guiWindow, bg = "#FFFF00")  
    ...
    del_button.place(x = 100, y = 160)  
    del_all_button.place(x = 100, y = 200)  
    exit_button.place(x = 100, y = 240)  
